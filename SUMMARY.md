...
* [Promise, async/await](javascript/promise-async-await.md)
* [this](javascript/this.md)

## 🤖 Functional Programming

* [함수형 프로그래밍 기본](functional-programming/undefined.md)
* [좋은 함수 만들기](functional-programming/undefined-1.md)
* [도메인 주도 설계](functional-programming/undefined-2.md)

## 🗄 Database

* [도커로 MySQL 데이터베이스 설치하기](database/mysql.md)

## 🌐 Network

* [주소창에 URL을 입력한 후 화면이 나오기까지의 과정](network/url.md)

## 🧮 Algorithms & Data Structure

* [Leetcode](algorithms-and-data-structure/leetcode/README.md)
